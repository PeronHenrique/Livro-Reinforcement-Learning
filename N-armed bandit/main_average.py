...
def main():
    seed = 123
    bandits_0_00: list[E_Greedy_Average_Bandit] = [E_Greedy_Average_Bandit(n=10, epsilon=0.00, seed=seed+i) for i in range(BANDITS)]
    bandits_0_01: list[E_Greedy_Average_Bandit] = [E_Greedy_Average_Bandit(n=10, epsilon=0.01, seed=seed+i) for i in range(BANDITS)]
    bandits_0_10: list[E_Greedy_Average_Bandit] = [E_Greedy_Average_Bandit(n=10, epsilon=0.10, seed=seed+i) for i in range(BANDITS)]
    bandits_opt_0_00: list[E_Greedy_Average_Bandit] = [E_Greedy_Average_Bandit(n=10, epsilon=0.00, seed=seed+i, initial_value=5) for i in range(BANDITS)]
    bandits_opt_0_01: list[E_Greedy_Average_Bandit] = [E_Greedy_Average_Bandit(n=10, epsilon=0.01, seed=seed+i, initial_value=5) for i in range(BANDITS)]
    bandits_opt_0_10: list[E_Greedy_Average_Bandit] = [E_Greedy_Average_Bandit(n=10, epsilon=0.10, seed=seed+i, initial_value=5) for i in range(BANDITS)]
